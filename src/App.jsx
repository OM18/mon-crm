...
{ label: "Creation Date", value: (() => { const v = sel.complianceCreationDate; if (!v) return null; const s = v.toString().trim(); if (/^\d{4,5}$/.test(s)) { const d = new Date(Math.round((parseInt(s) - 25569) * 86400 * 1000)); return `${String(d.getDate()).padStart(2,"0")}/${String(d.getMonth()+1).padStart(2,"0")}/${d.getFullYear()}`; } if (/^\d{4}-\d{2}-\d{2}$/.test(s)) return s.split("-").reverse().join("/"); return s; })() },
                { label: "Last Update Date", value: (() => { const v = sel.complianceLastUpdateDate; if (!v) return null; const s = v.toString().trim(); if (/^\d{4,5}$/.test(s)) { const d = new Date(Math.round((parseInt(s) - 25569) * 86400 * 1000)); return `${String(d.getDate()).padStart(2,"0")}/${String(d.getMonth()+1).padStart(2,"0")}/${d.getFullYear()}`; } if (/^\d{4}-\d{2}-\d{2}$/.test(s)) return s.split("-").reverse().join("/"); return s; })() },
                { label: "Request Date", value: (() => { const v = sel.complianceRequestDate; if (!v) return null; const s = v.toString().trim(); if (/^\d{4,5}$/.test(s)) { const d = new Date(Math.round((parseInt(s) - 25569) * 86400 * 1000)); return `${String(d.getDate()).padStart(2,"0")}/${String(d.getMonth()+1).padStart(2,"0")}/${d.getFullYear()}`; } if (/^\d{4}-\d{2}-\d{2}$/.test(s)) return s.split("-").reverse().join("/"); return s; })() },
                { label: "Last Reception Date", value: (() => { const v = sel.complianceLastReceptionDate; if (!v) return null; const s = v.toString().trim(); if (/^\d{4,5}$/.test(s)) { const d = new Date(Math.round((parseInt(s) - 25569) * 86400 * 1000)); return `${String(d.getDate()).padStart(2,"0")}/${String(d.getMonth()+1).padStart(2,"0")}/${d.getFullYear()}`; } if (/^\d{4}-\d{2}-\d{2}$/.test(s)) return s.split("-").reverse().join("/"); return s; })() },
                { label: "Final Confirmation Date", value: (() => { const v = sel.complianceFinalConfirmationDate; if (!v) return null; const s = v.toString().trim(); if (/^\d{4,5}$/.test(s)) { const d = new Date(Math.round((parseInt(s) - 25569) * 86400 * 1000)); return `${String(d.getDate()).padStart(2,"0")}/${String(d.getMonth()+1).padStart(2,"0")}/${d.getFullYear()}`; } if (/^\d{4}-\d{2}-\d{2}$/.test(s)) return s.split("-").reverse().join("/"); return s; })() },
              ].map(row => (
